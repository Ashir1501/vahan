    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duration', models.CharField(choices=[('4 hrs 40 km', '4 hrs 40 km'), ('8 hrs 80 km', '8 hrs 80 km'), ('12 hrs 120 km', '12 hrs 120 km')], default=('4 hrs 40 km', '4 hrs 40 km'), max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('licence', models.ImageField(default=None, upload_to='driver_images')),
                ('aadhar_card', models.ImageField(default=None, upload_to='driver_images')),
                ('join_date', models.DateField()),
                ('exit_date', models.DateField()),
                ('otp', models.CharField(max_length=10)),
                ('created_at', models.DateTimeField(auto_now=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('updated_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='acc', to=settings.AUTH_USER_MODEL)),
