...
class userListCreateView(View):
    ...
    def post(self, request, *args, **kwargs):
        if request.headers.get('x-requested-with') == 'XMLHttpRequest':
            ...
            user_detail.gender = gender if gender else AccountDetail.GENDER_CHOICES[3][0]
            ...
            user_detail.updated_by = request.user.first_name if request.user.is_authenticated else None
            user_detail.save()
...
class updateUser(View):
    def post(self,request,*args,**kwargs):
        ...
        accountDetail.gender = new_gender if new_gender else AccountDetail.GENDER_CHOICES[3][0]
